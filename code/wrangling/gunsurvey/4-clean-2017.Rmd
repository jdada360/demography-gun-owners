...
Need codebook because it looks like 5 levels instead of 6 (which is what is in the other years) so no one is Asian, non-hispanic
...
Do any of these guns personally belong to you? = `gunhomeper`. There are `r nrow(filter(raw, q33 =="NA"))` observations with NA hardcoded for `q33`. This corresponds to people who said answered no to q32.
