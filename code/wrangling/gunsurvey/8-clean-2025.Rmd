...
There are so many missing values for these age groups for some reason.

So for this year we define hhun18 = hhsize - hh18ov and then for negative values we replace with the modal hhun18 val = 2.
