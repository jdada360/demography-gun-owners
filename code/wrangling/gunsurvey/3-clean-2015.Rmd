...
There are 25 rows with missing data on `weight3`. According to the documentation, the sample size of the total respondents is the number of observations in the data set (`r nrow(clean)`) minus 25 = 1326. So we drop these observations.
