...
-   `hhsize4` = categorical = weighted by weigh - gun owner
...
hist(merge$hh18un)
```
2025 is the year with a lot of missing values for hhsize variables so we use the hhsize-hh18ov and impute the median (2). 
...
Define a grouping that matches Barry et al. 2018.
...
For 2017 and 2019, there are only gun-owner specific weights, which is `weight1`.
